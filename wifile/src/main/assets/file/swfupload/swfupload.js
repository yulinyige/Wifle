...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	...
	var tmp = ['<object id="', this.movieName, '" type="application/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload"',
                '>',
    ...
    html.push('<object id="');
    html.push(this.movieName);
    html.push('" type="application/x-shockwave-flash" data="');
    html.push((this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url));
    html.push('" width="');
    html.push(this.settings.button_width);
    html.push('" height="');
    html.push(this.settings.button_height);
    html.push('" class="swfupload"');
    ...
    html.push('<param name="wmode" value="');
    html.push(this.settings.button_window_mode);                                            
    html.push('" />');
